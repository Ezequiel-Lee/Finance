const Storage = {
    get() {
        return JSON.parse(localStorage.getItem("Lee.finaces:transactions")) || [];
    },

    set(transactions) {
        localStorage.setItem("Lee.finaces:transactions", JSON.stringify(transactions));
    }
}
...
const Transaction = {
    ...
    remove(index) {
        ...
        const remove = new Audio('./public/assets/audio/remove.mp3')
        remove.play();
    ...
    extract() {
        ...
        Utils.download(text, "Lee.finances.txt", "application/text");
    }
}
...
const DOM = {
    ...
    innerHTMLTransaction(transaction, index) {
        ...
        const html = `
            ...
            <td class="edit">
                <img onclick="Transaction.edit(${index})" src="public/assets/edit.svg" alt="Editar Transação" onload="SVGInject(this)">
            </td>
            <td class="delete" onclick="remove.play()">
                <img onclick="Transaction.remove(${index})" src="public/assets/trash.svg" alt="Remover Transação" onload="SVGInject(this)">
            </td>
        `        
        return html;
...
const Form = {
    ...
    validateFields() {
        ...
        const add = new Audio('./public/assets/audio/add.mp3')
        add.play();
    },
